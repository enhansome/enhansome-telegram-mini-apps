...
> Resources in other languages can be found [here](https://github.com/telegram-mini-apps-dev/awesome-telegram-mini-apps/blob/main/resources_other_languages.md#resources-in-other-languages) ⭐ 1,398 | 🐛 56 | 📅 2026-05-05.
...
* [@tonconnect/ui](https://github.com/ton-connect/sdk/tree/main/packages/ui) ⭐ 547 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-01 - Authorize your app's users with their TON wallets.
...
* [@twa.js](https://github.com/Telegram-Web-Apps/twa.js) ⭐ 1,202 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-14 - A monorepository that contains everything you need to develop Telegram Mini Apps in TypeScript.
