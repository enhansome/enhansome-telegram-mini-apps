...
> Resources in other languages can be found [here](https://github.com/telegram-mini-apps-dev/awesome-telegram-mini-apps/blob/main/resources_other_languages.md#resources-in-other-languages) ⭐ 1,400 | 🐛 58 | 📅 2026-05-05.
...
* [Telegram UI](https://github.com/Telegram-Mini-Apps/TelegramUI) ⭐ 858 | 🐛 44 | 🌐 TypeScript | 📅 2025-10-14 - Telegram UI kit equips you with a variety of pre-designed components and tools to help you quickly develop high-quality Telegram applications.
* [@tonconnect/ui](https://github.com/ton-connect/sdk/tree/main/packages/ui) ⭐ 547 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-22 - Authorize your app's users with their TON wallets.
...
* [@twa.js](https://github.com/Telegram-Web-Apps/twa.js) ⭐ 1,203 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-14 - A monorepository that contains everything you need to develop Telegram Mini Apps in TypeScript.
...
* [telegram-webapp-auth](https://github.com/swimmwatch/telegram-webapp-auth) ⭐ 98 | 🐛 6 | 🌐 Python | 📅 2026-09-18 - Init data validation utilities for Python.
...
* [MemoCard](https://github.com/kubk/memo-card) ⭐ 146 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Flashcard app for improving memory with spaced repetition.
